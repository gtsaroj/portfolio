...
<div className={
    ...
    <div className="qualification__data">
        <div>
            ...
            <span className="qualification__subtitle">Udemy online course</span>
      ...
      <div className="qualification__data">
        ...
        <div>
            ...
            <span className="qualification__subtitle">Tribhuwan Secondary School</span>
            <div className="qualification__calender">
                <i className="uil uil-calender-alt"></i>
                2020 -2022
            </div>
...
<div className={
    ...
    <div className="qualification__data">
        <div>
            <h2 className="qualification__title">Web Design</h2>
            <span className="qualification__subtitle">DG Tech Nepal</span>
            <div className="qualification__calender">
                <i className="uil uil-calender-alt"></i>
                2022
            </div>
    ...
    {/* dublicate of up */}
        ...
        <div>
            <h2 className="qualification__title">web Development</h2>
            <span className="qualification__subtitle">graphStick Nepal</span>
            <div className="qualification__calender">
                <i className="uil uil-calender-alt"></i>
