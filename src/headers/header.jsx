            ...
            <nav className="nav container">
                ...
                <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                    ...
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            <a href='#services' onClick={() => setActiveNav("#services")} className={activeNav === "#services" ? "nav__link active" : "nav__link"}>
                                <i className="uil uil-scenery nav__icon"></i>Services
                            </a>
                        </li>
                        <li className="nav__item">
                            <a href='#profile' onClick={() => setActiveNav("#profile")} className={activeNav === "#profile" ? "nav__link active" : "nav__link"}>
                                <i className="uil uil-message nav__icon"></i>Profile </a>

                        </li>
                        <li className="nav__item">
                            <a href='#contact' onClick={() => setActiveNav("#contact")} className={activeNav === "#contact" ? "nav__link active" : "nav__link"}>
